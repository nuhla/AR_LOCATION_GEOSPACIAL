    ...
    public class VpsInitializer : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            if (ARCoreExtensions == null)
            {
                ...
                debugText.text = "Cannot find ARCoreExtensions.";
            }
        }
        ...
        private IEnumerator StartLocationService()
        {
            ...
            if (!Permission.HasUserAuthorizedPermission(Permission.FineLocation))
            {
                ...
                debugText.text = "Requesting fine location permission";
            ...
            if (!Input.location.isEnabledByUser)
            {
                ...
                debugText.text = "Location service is disabled by User.";
                _waitingForLocationService = false;
                yield break;
            }

            Debug.Log("Start location service.");
            debugText.text = "Start location service.";
            ...
            if (Input.location.status != LocationServiceStatus.Running)
            {
                ...
                debugText.text = "Location service ends with {0} status.";
                Input.location.Stop();
            }
        }
        /// <summary>
        ...
        public void OnDisable()
        {
            ...
            debugText.text = "Stop location services.";
            Input.location.Stop();
        }
        ...
        public void Update()
        {
            ...
            switch (featureSupport)
            {
                ...
                case FeatureSupported.Unsupported:
                    ...
                    debugText.text = "Geospatial API is not supported by this devices.";
                    return;
